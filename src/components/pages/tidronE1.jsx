...
const TidronE1CollectionProducts= () =>{
    ...
    useEffect(() => {        
        tidronE1Ref.current.scrollIntoView({behavior: 'smooth', block: 'start'});  
    },[]);
    ...
    return(
        <>
            <HelmetProvider> <Helmet>
                <title>Eisbach Watches | TIDRON E1 </title>
                <meta name="description" content="Explore the underwater world with the Eisbach Watches TIDRON E1. Our Swiss made automatic Diver and Tool watch is designed for those seeking precision and style" />        
                <link rel="canonical" href={process.env.REACT_APP_URL_CUSTOM+"watches/tidron-e1"} />
                <link rel="alternate" hreflang="x-default" href={process.env.REACT_APP_URL+"watches/tidron-e1"} />
                <meta property="og:title" content="Eisbach Watches | TIDRON E1" />
                <meta property="og:type" content="website" />
				<meta property="og:description" content="Explore the underwater world with the Eisbach Watches TIDRON E1. Our Swiss made automatic Diver and Tool watch is designed for those seeking precision and style" />
                <meta property="og:url" content={process.env.REACT_APP_URL_CUSTOM+"watches/tidron-e1"}/>
...
export default TidronE1CollectionProducts;